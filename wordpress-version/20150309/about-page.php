...
<!--here are the different blocks of content-->
	...
	<section  class="col-lg-8 col-md-8 main">
		<h3 class="show-hide resume-section "> Education <span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></h3>
