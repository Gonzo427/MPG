...
register_nav_menus( array(
    'primary' => __( 'Primary', 'primary-menu' ),
	'woodcut' => __('Woodcut Menu', 'woodcut-menu' ),
	'drawing' => __('Drawing Menu', 'drawing-menu' ),
	'painting' => __('Painting Menu', 'painting-menu' )
) );
require_once('wp_bootstrap_navwalker.php');
add_action( 'after_setup_theme', 'wpt_setup' );
    if ( ! function_exists( 'wpt_setup' ) ):
        function wpt_setup() {  
            register_nav_menu( 'primary', __( 'Primary', 'test' ) );
        } endif;
